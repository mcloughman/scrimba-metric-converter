...
btn.addEventListener("click", function() {
    ...
    massP.textContent = `${numToConvert} kilos = ${massObj.pounds} gpounds | ${numToConvert} pounds= ${massObj.kilos} kilos`
...
function volumeConverter(num) {
    const gallons = (num * .264).toFixed(3)
    const liters = (num / .264).toFixed(3)
